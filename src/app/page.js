...
export default function Home () {
  ...
  return (
    <main className='flex min-h-screen font-bricolage-grotesque  min-w-md h-screen flex-col items-center justify-start bg-base-200'>
      ...
      {/* Main Screen*/}
      <div>
        <h1 className='text-base-content text-4xl font-bold p-4 pt-8 pb-12'>
      ...
      {selectedFiles.length == 0 && (
        <div className='w-full h-full  flex items-start justify-center'>
          {/* File updalder */}
          <div className='w-1/2 h-1/3 rounded-xl border-dashed border-base-300 bg-base-100 border-2'>
