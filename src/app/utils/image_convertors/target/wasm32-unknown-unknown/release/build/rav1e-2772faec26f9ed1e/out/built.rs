...
#[allow(dead_code)]
pub const RUSTC: &str = r"/Users/arielroasso/.rustup/toolchains/stable-x86_64-apple-darwin/bin/rustc";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub const RUSTDOC: &str = r"/Users/arielroasso/.rustup/toolchains/stable-x86_64-apple-darwin/bin/rustdoc";
...
#[doc=r#"The output of `/Users/arielroasso/.rustup/toolchains/stable-x86_64-apple-darwin/bin/rustc -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.80.1 (3f5fd8dd4 2024-08-06)";
#[doc=r#"The output of `/Users/arielroasso/.rustup/toolchains/stable-x86_64-apple-darwin/bin/rustdoc -V`; empty string if `/Users/arielroasso/.rustup/toolchains/stable-x86_64-apple-darwin/bin/rustdoc -V` failed to execute"#]
#[allow(dead_code)]
